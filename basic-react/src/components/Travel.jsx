const Travel = ({imageUrl, date, country, title, description}) => (
    <>
        <div className="my-[45px] px-[40px] flex flex-col gap-[34px] text-sm text-default font-[Inter]">
            <div className="flex gap-4">
                ...
                <div className="flex flex-col w-full">
                 ...
                 <p className="font-bold text-[0.9rem]">{date}</p>
                 <p>
                     {description}
                 </p>
             </div>
